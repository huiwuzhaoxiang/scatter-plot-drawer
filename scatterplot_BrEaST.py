...
def create_network_performance_plot(csv_file_path, output_path='ISIC2017_miou.png'):
    ...
    for idx, row in df.iterrows():
        ...
        elif network_name == 'EGE-Unet':
            offset_x = -60
            offset_y = -5
            ha = 'right'
            va = 'center'
        elif network_name == 'UNeXt-S':
            offset_x = 12.5
            offset_y = -30
            ha = 'left'
            va = 'bottom'
...
if __name__ == "__main__":
    ...
    # 如果你有自己的CSV文件，使用以下代码：
    create_network_performance_plot('C:/Users/45730/Desktop/BrEaST.csv', 'BrEaST_miou.png')
